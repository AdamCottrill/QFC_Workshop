...
+ relatively simple to write custom snippets
  + [[http://capitaomorte.github.io/yasnippet/snippet-development.html][~/yasnippet/snippet-development.html]]
+ snippets for ~R~, \LaTeX, ~sweave~ / ~knitr~, ~admb~ provided in workshop configuration
+ try it
